...
- Transactions can be edited from the Transactions drawer (any record) or via Edit latest transaction on a holding row. After editing from the list, return to the Transactions drawer.
